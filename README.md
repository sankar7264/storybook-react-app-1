...
Reference Documents:
 https://docs.wpvip.com/technical-references/vip-dashboard/deployments-panel/ 

https://docs.wpvip.com/technical-references/node-js/#h-exposing-a-health-check-endpoint 

Manage or set the environment variables:

We can set the environment variables using VIP-CLI. To install VIP-CLI on local machine follow the steps given in VIP-CLI document. Once the VPI CLI is install we can use following commands to set the environment variable.
...
vip @{application_name}.{environment} config envvar get-all command will give the list of all previously set environment variables.
...
https://docs.wpvip.com/vip/config/envvar/set/ 

https://docs.wpvip.com/vip/config/envvar/list/
## Acknowledgements
